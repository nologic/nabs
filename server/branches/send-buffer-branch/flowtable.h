...
struct flow_content {
	...
	struct flow_record *fr; /* pointer to flow record in send buffer */
	struct send_buffer *sb; /* send_buffer to which fr belongs */
...
int flowtable_init(struct flow_table *, unsigned int, struct sb_config *sb);
