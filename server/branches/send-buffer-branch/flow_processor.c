...
static inline void flush_flow_record(struct sb_config *sbc, struct flow_content *f)
{
	mark_chunk_flushable(sbc, f->sb, (void *)f->fr);
	f->fr = NULL; /* just to be safe */
}
