...
public class DiskResultSet {
    ...
    private FileOutputStream indexFout;
    ...
    public DiskResultSet(String name) {
        fileName = name;
        randomOpen = false;
    ...
    private void openFile() throws IOException {
        ...
        bout = new BufferedOutputStream(fout, 65536);
        dout = new CountingDataOutputStream(bout);
        
        indexFout = new FileOutputStream(fileName + ".idx");
        indexBout = new BufferedOutputStream(indexFout, 65536);
    ...
    public Iterator getRowIterator() throws IOException {
        return new RowIterator(fileName, rowCount);
    }
    ...
    public void prepareRandomReads() throws IOException {
        ...
        try {
            dataRaf = new RandomAccessFile(fileName, "r");
            indexRaf = new RandomAccessFile(fileName + ".idx", "r");
