...
public class AddReceptorIcon implements DesktopIcon {
    ...
    public String getName() {
        return "Add " + NABStrings.CURRENT_RECEPTOR_NAME;
    }
    ...
    public void activate() {
        String val = (String)JOptionPane.showInputDialog(MainGui.v(), "Enter the " + NABStrings.CURRENT_RECEPTOR_NAME + " ip and port in the form of IP:[Port]", "Add new " + NABStrings.CURRENT_RECEPTOR_NAME,
        ...
        if(val != null){
            try {
                ...
                logger.error("Unable to add new " + NABStrings.CURRENT_RECEPTOR_NAME + ": " + ex.getMessage());
            }
        }
    }
    ...
    private void addNewReceptor(String spec) throws IOException {
        ...
        if(ReceptorManager.ins.addReceptor(name, ip, port, 1500) == null){
            logger.info(NABStrings.CURRENT_RECEPTOR_NAME + " by name '" + name + "' already exists.");
        } else {
