...
public class ModuleLinker {
    ...
    public ModuleLinker(String subname, Receptor rec) {
        ...
        libraryLoader = new ModuleClassLoader(new URL[]{});
        ...
        for (int i = 0; i < deps.length; i++) {
            ...
            if(desc != null) {
                ...
                try {
                    ...
                    /*
                     * This is a fix for a problem when there is a deep (2+) dep tree
                     *  and the module is instantiated before all the deps were also linked.
                     *  This fix could potentially break circular dependency modules.
                     **/
                    loadDependencies(desc);
    ...
    public void loadModule(File jarFile) throws MalformedURLException, InvalidModuleFormatException {
        ...
        try {
            ...
            //System.out.println("Dep missing: " + ex.getMessage());
        } catch (Throwable ex) {
            ex.printStackTrace();
