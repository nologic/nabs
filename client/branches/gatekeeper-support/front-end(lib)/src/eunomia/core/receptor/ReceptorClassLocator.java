...
import eunomia.util.oo.NabClassLocator;
...
public class ReceptorClassLocator implements NabClassLocator {
    ...
    public ReceptorClassLocator() {
        ...
        try {
            ...
            addClass(eunomia.messages.receptor.msg.rsp.StatusMessage.ModuleDescriptor.class);
            addClass(eunomia.messages.receptor.msg.rsp.StatusMessage.StreamServer.class);
            ...
            addClass(eunomia.messages.receptor.msg.rsp.admin.AdminStatusMessage.ModDesc.class);
            ...
            addClass(eunomia.util.oo.LargeTransfer.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private Class mapClass(int hash) {
        lock();
        lookup.hash = hash;
