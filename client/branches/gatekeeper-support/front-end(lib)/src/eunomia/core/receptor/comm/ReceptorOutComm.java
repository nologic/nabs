...
import com.vivic.eunomia.sys.frontend.ReceptorCommunicator;
 ...
 */
public class ReceptorOutComm implements ReceptorCommunicator {
    ...
    public void getAnalysisSummaryReport() {
        receptor.sendMessage(new SignalMessage(SignalMessage.SIG_GET_DB_SUMMARY));
    }
    ...
    public void startAnalysis(ModuleHandle module, String[] databases, byte[] bytes){
        StartAnalysisMessage msg = new StartAnalysisMessage();
        ...
        msg.setDatabases(databases);
        msg.setModuleHandle(module);
        msg.setParams(bam);
    ...
    public void getAnalysisParameters(ModuleHandle handle) {
        GetAnalysisParametersMessage msg = new GetAnalysisParametersMessage();
