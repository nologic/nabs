 ...
 */
public class ChannelEndTimeKeyCreator implements SecondaryKeyCreator, EnvironmentKeyCreator, SqlEnvironmentKeyCreator {
    private static String[] colNames;
    private static String[] colTypes;

    static {
        colNames = new String[]{"lastAct"};
    ...
    public ChannelEndTimeKeyCreator() {
    }
