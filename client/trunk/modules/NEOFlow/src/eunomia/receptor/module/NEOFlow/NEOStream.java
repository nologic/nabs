 ...
 */
public class NEOStream implements FlowCreator {
    /**
     * A flow object used by the creator.
     */
    private NEOFlow flow;
     ...
     */
    public NEOFlow processBuffer(ByteBuffer buff) {
    ...
    public int getBufferSize() {
        ...
        return 1024 * NEOFlow.FLOW_BYTE_SIZE;
    }
}
