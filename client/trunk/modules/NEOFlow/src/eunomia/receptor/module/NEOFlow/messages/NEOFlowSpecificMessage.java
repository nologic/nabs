...
package eunomia.receptor.module.NEOFlow.messages;
 ...
 */
public class NEOFlowSpecificMessage implements Message {
    /**
    ...
    public NEOFlowSpecificMessage() {
        allowType = new boolean[NEOFlow.NUM_TYPES];
        allowProto = new boolean[2];
        tcpFlagRanges = new int[NEOFlow.NUM_TCP_FLAGS][2];
    }
