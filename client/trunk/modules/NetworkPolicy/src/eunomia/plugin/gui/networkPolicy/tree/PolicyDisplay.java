...
public class PolicyDisplay extends JList implements ListSelectionListener, ListCellRenderer, MouseListener {
    ...
    public PolicyDisplay() {
        ...
        blank_sign = new ImageIcon(getClass().getClassLoader().getResource("eunomia/plugin/icons/list-blank.png"));
        plus_sign = new ImageIcon(getClass().getClassLoader().getResource("eunomia/plugin/icons/list-add.png"));
        minus_sign = new ImageIcon(getClass().getClassLoader().getResource("eunomia/plugin/icons/list-remove.png"));
