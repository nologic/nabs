...
package com.vivic.eunomia.filter;
...
public class Filter {
    ...
    public ChangeFilterMessage getChangeFilterMessage() {
        ChangeFilterMessage cfm = new ChangeFilterMessage();
        
        cfm.setBlackList(blackList.getAsMessageArray());
        cfm.setWhiteList(whiteList.getAsMessageArray());
