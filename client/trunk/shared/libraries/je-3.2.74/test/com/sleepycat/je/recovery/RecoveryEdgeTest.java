 ...
 *
 * $Id: RecoveryEdgeTest.java,v 1.58.2.4 2008/02/26 03:08:59 linda Exp $
 */
...
public class RecoveryEdgeTest extends RecoveryTestBase {
    public void testNoLogFiles()
        ...
        try {
            ...
            noFileConfig.setConfigParam(EnvironmentParams.LOG_MEMORY_ONLY.
                                        getName(),
                                        "true");
    ...
    public void testTxnId()
        ...
        try {
            ...
            EnvironmentConfig recoveryConfig = TestUtils.initEnvConfig();
            recoveryConfig.setConfigParam (EnvironmentParams.ENV_RUN_CLEANER.
                                           getName(),
                                           "false");
    ...
    /**
     * Test that we can recover with no checkpoint start.
     */
    public void testNoCheckpointStart() 
        throws Exception {
        ...
        truncateAtEntry(LogEntryType.LOG_CKPT_START);
        env.close();
