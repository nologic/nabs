 ...
 *
 * $Id: ToManyExample.java,v 1.5.2.1 2007/02/01 14:49:36 cwl Exp $
 */
...
public class ToManyExample {
    ...
    private ToManyExample(String homeDir) throws DatabaseException {
        ...
        try {
            ...
            dataBinding = new SerialBinding(catalog, null);
    ...
    private Animal insertAndPrintAnimal(String name, boolean furry)
        ...
        dataBinding.objectToEntry(animal, data);
    ...
    private void printPerson(String name)
        ...
        if (status == OperationStatus.SUCCESS) {
            Person person = (Person) dataBinding.entryToObject(data);
            person.name = (String) keyBinding.entryToObject(key);
    ...
    private class EmailKeyCreator implements SecondaryMultiKeyCreator {
        ...
        public void createSecondaryKeys(SecondaryDatabase secondary,
            ...
            Person person = (Person) dataBinding.entryToObject(primaryData);
     ...
     */
    private void copyKeysToEntries(Set keys, Set entries) {
    ...
    private class AnimalKeyNullifier implements ForeignMultiKeyNullifier {
        ...
        public boolean nullifyForeignKey(SecondaryDatabase secondary,
            ...
            Person person = (Person) dataBinding.entryToObject(primaryData);
            String key = (String) keyBinding.entryToObject(secKey);
            if (person.favoriteAnimals.remove(key)) {
                dataBinding.objectToEntry(person, primaryData);
                return true;
            } else {
                return false;
            }
