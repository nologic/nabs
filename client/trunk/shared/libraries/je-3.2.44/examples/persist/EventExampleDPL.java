 ...
 *
 * $Id: EventExampleDPL.java,v 1.1.2.1 2007/02/01 14:49:37 cwl Exp $
 */
 ...
 * java -cp je.jar EventExampleDPL -h <environmentDirectory>
 * </pre>
 */
public class EventExampleDPL {
     ...
     * objects stored in a JE database.
     */
    @Entity
    static class Event {
     ...
     * Usage: java -cp je.jar EventExampleDPL -h <envHome>
