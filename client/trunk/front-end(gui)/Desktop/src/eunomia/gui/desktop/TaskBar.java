...
import eunomia.gui.desktop.listeners.DesktopManagerListerner;
import eunomia.gui.desktop.WrappingFlowLayout;
import java.awt.*;
...
public class TaskBar extends JPanel implements DesktopManagerListerner, ActionListener, NabInternalFrameListener {
    ...
    static {
        buttonSize = new Dimension(160, 27);
    }
    ...
    public TaskBar() {
        ...
        scroll.getVerticalScrollBar().setBlockIncrement(27);
