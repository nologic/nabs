...
public abstract class ModulePortal extends NabInternalFrame implements ActionListener, 
    ...
    protected Frame getOwner() {
        ...
        // so we have to recreate each time.
        try {
    ...
    public JButton addToolbarButton(String name, String desc, Icon icon, ActionListener l) {
        JButton button = makeButton(name, desc, icon);
