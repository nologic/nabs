 ...
 */
public class ProcMiddlewareModule extends MiddlewareModule implements ReceptorProcessorModule, ServerLinkListener, ReportingModule {
    private ReceptorProcessorModule module;
    ...
    public ProcMiddlewareModule(ModuleHandle hdl, ReceptorProcessorModule mod) {
        super(hdl, mod);
