...
import eunomia.messages.receptor.protocol.impl.FILEProtocol;
...
public class ReceiverProtocol {
    ...
    public SelectableChannel openChannel() throws IOException, UnsupportedOperationException, AlreadyConnectedException {
        ...
        if(descriptor instanceof TCPProtocol) {
            ...
            sChannel = sock;
        } else if(descriptor instanceof FILEProtocol) {
            FILEProtocol file = (FILEProtocol)descriptor;
            FileInputStream fin = new FileInputStream(file.getFile());
            //sChannel = fin.getChannel();
        } else {
    ...
    public static String getDescriptorString(ProtocolDescriptor desc) {
        ...
        } else if(desc instanceof FILEProtocol) {
            return ((FILEProtocol)desc).getFile();
        }
    ...
    public static ProtocolDescriptor getDescriptorObject(String proto, String str) {
        ...
        if(proto.equals("TCP")) {
            ...
            FILEProtocol file = new FILEProtocol();
            file.setFile(str);
            desc = file;
        }
